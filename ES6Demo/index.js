...
// let [a,b="zz"] = ["周卓", undefined];
// console.log(a+b);

// let [a,b="zz"] = ["周卓",null];
// console.log(a+b);

// let {foo,bar} = {bar:'周卓',foo:'zz'};
// console.log(foo+bar);
...
// let zz = '周卓';
// let blog = '感觉非常的不错周卓';
// document.write(blog.indexOf(zz));
// document.write(blog.includes(zz));

//判断是否是数字
// let a = 11/4;
// console.log(Number.isFinite(a));
// console.log(Number.isFinite('zz'));
...
// }
// console.log(obj[zz]);
// console.log(obj.zz);//这样取值取不到
// obj[zz] = '周大卓';
// console.log(obj[zz]);

//Symbol对象元素的保护作用
// let obj = {name:'zz', skill:'web', age:18};
// for (let item in obj) {
...
// let setArr = new Set(['zz', '周卓', 'web', 'web',]);
// setArr.add('前端技术');//增
// console.log(setArr);
...
class Coder {
    ...
    skill(val) {
        console.log(this.name('周卓') + ':' + 'skill-' + val);
    }
